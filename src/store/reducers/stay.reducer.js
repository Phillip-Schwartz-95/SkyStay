...
function unitTestReducer() {
    ...
    const stay1 = { _id: 'b101', title: 'Stay ' + parseInt('' + Math.random() * 10), price: 120, host: null, msgs: [] }
    const stay2 = { _id: 'b102', title: 'Stay ' + parseInt('' + Math.random() * 10), price: 130, host: null, msgs: [] }
